...
RSpec.describe Day15 do
  ...
  describe '#part_two' do
    it 'loads the map extra wide' do
      sim = Day15::PartTwo.new(input)
      expect(sim.to_map).to eq(wide_map)
    end

    it 'takes steps' do
      sim = Day15::PartTwo.new(final_small_input)
      sim.step!('<')
      expect(sim.to_map).to eq(
        <<-MAP
##############
##......##..##
##..........##
...
##############
    ...
    it 'outputs the correct map' do
      sim = Day15::PartTwo.new(final_small_input)
      sim.run!
      expect(sim.to_map).to eq(final_small_part_2)
    end

    it 'calculates the correct map for part two' do
      sim = Day15::PartTwo.new(input)
      sim.run!
      expect(sim.to_map).to eq(
        <<-MAP
...
####################
    ...
    it 'calculates the correct solutions for part two' do
      expect(subject.part_two(input)).to eq(9021)
    end
  end
